            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LancheId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(type: "nvarchar(5)", maxLength: 80, nullable: false),
                    DescriçãoCurta = table.Column<string>(type: "nvarchar(5)", maxLength: 200, nullable: false),
                    DescriçãoDetalhada = table.Column<string>(type: "nvarchar(5)", maxLength: 200, nullable: false),
