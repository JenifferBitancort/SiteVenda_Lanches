...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,CategoriaNome,Descrição")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,CategoriaNome,Descrição")] Categoria categoria)
        {
