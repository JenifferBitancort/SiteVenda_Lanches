...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminlanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescriçãoCurta,DescriçãoDetalhada,Preço,ImagemUrl,ImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescriçãoCurta,DescriçãoDetalhada,Preço,ImagemUrl,ImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] lanche lanche)
        {
